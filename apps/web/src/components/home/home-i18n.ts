...
const vi: HomeCopy = {
  ...
  diff: {
    eyebrow: "Vì sao chọn Tailor Moments",
    title: "Không cần lên kế hoạch. Không phải đoán mò. Chỉ một ngày trọn vẹn.",
    items: [
      { icon: "◎", label: "Không cần tài khoản", body: "Chúng tôi chỉ cần ngày đi và sở thích của bạn. Không cần đăng nhập, không đặt cọc cho đến khi nhà máy rượu xác nhận." },
      { icon: "◍", label: "Đã bao gồm xe đưa đón riêng", body: "Tận cửa bằng xe riêng — từ Perth, Busselton hoặc biệt thự của bạn đến vườn nho và trở về." },
      { icon: "✦", label: "Mọi đặt chỗ đều xác nhận trước", body: "Mỗi hầm rượu, mỗi chỗ nếm thử và bữa trưa thong thả đều được đặt trước ngày bạn đến. Bạn chỉ việc đến nơi." },
      { icon: "◈", label: "Hợp với khẩu vị cả nhóm", body: "Công cụ AI xây dựng ngày của bạn quanh những người đồng hành — phong cách rượu, dịp đặc biệt, nhịp độ và nhu cầu ăn uống." },
    ],
  },
  itinPreview: {
    ...en.itinPreview,
    eyebrow: "Điều bạn có thể mong đợi",
    title: "Một ngày được thiết kế riêng cho bạn",
    lead: "Mỗi hành trình đều độc nhất. Đây là một ví dụ — và lý do vì sao nó được chọn.",
    aiLabel: "Vì sao chúng tôi chọn điều này cho bạn",
    aiText: "Bạn cho biết sẽ đi cùng gia đình và yêu thích dòng vang trắng nhẹ nhàng với nhịp độ thư thả. Chúng tôi chọn ba hầm rượu nổi tiếng nồng hậu và sắp xếp cả ngày thật khoan thai để bạn không bao giờ phải vội — kèm một bữa trưa thong thả ngay tại điền trang.",
    stops: [
      { time: "10:00", name: "Vasse Felix", desc: "Buổi nếm mở đầu — vang trắng tuyển chọn và Chardonnay của điền trang", type: "Hầm rượu" },
      { time: "12:30", name: "Tom Cullity Restaurant", desc: "Bữa trưa thong thả tại nhà hàng của nhà máy rượu — thực đơn nếm thử theo mùa", type: "Bữa trưa" },
      { time: "14:30", name: "Cullen Wines", desc: "Điền trang sinh học động lực — buổi nếm thử riêng tư có chỗ ngồi", type: "Hầm rượu" },
      { time: "16:30", name: "Đưa đón trở về", desc: "Xe riêng đưa thẳng về nơi bạn lưu trú", type: "Đưa đón" },
    ],
    note: "Chỉ là hành trình mẫu. Hành trình của bạn sẽ được xây dựng từ chính sở thích của bạn.",
    cta: "Thiết kế ngày của tôi",
  },
  testimonials: {
    ...en.testimonials,
    eyebrow: "Câu chuyện của khách",
    title: "Lời từ thung lũng",
    partnersLabel: "Hợp tác cùng những điền trang sáng lập của vùng",
    quotes: [
      { quote: "Chỉ trong một ngày, chúng tôi đã thấy nhiều hơn cả ba lần ghé thăm trước đó — mà chưa một lần phải nhìn bản đồ.", name: "Mei L.", city: "Singapore" },
      { quote: "Thời gian được sắp xếp hoàn hảo. Đến mỗi nhà máy rượu là buổi nếm thử riêng của chúng tôi vừa bắt đầu. Cảm giác thực sự độc quyền, không hề giống một tour du lịch.", name: "David & Sarah K.", city: "Kuala Lumpur" },
      { quote: "Một ngày thật nhẹ nhàng. Concierge biết chính xác nên rót cho chúng tôi những loại rượu nào. Chúng tôi đã giới thiệu Tailor Moments cho sáu người bạn.", name: "Chen Wei", city: "Thượng Hải" },
    ],
  },
  location: {
    ...en.location,
    eyebrow: "Đường đến nơi",
    title: "Ba giờ về phía nam Perth. Một thế giới khác biệt.",
    body: "Margaret River nằm ở mũi của dãy Leeuwin-Naturaliste — những khu rừng karri cổ thụ, bờ biển lướt sóng hoang sơ và một trong những vùng rượu vang danh tiếng nhất nước Úc, tất cả trong tầm một ngày đường từ sân bay Perth hoặc Busselton.",
    stats: [
      { num: "270 km", label: "về phía nam Perth" },
      { num: "3 giờ", label: "đường bộ" },
      { num: "10 phút", label: "đến Ấn Độ Dương" },
      { num: "200+", label: "hầm rượu trong vùng" },
    ],
  },
  cta: {

...
const zhHans: ExploreCopy = {
  ...
  guestFallback: "您们一行",
  steps: {
    trip: { kicker: "第一章", label: "您的行程", title: "先为这一天定个基调。" },
    palate: { kicker: "第二章", label: "您的口味", title: "杯中该有些什么？" },
    occasion: { kicker: "第三章", label: "此行缘由", title: "这趟来访，为何而来？" },
    care: { kicker: "第四章", label: "悉心照料", title: "几个小细节，让每一站都贴心妥帖。" },
  },
  fields: {
    name: "怎么称呼您？",
    date: "您计划哪天到访？",
    ...
    groupUnit: "位（含您本人）",
    pace: "您想要怎样的一天？",
    paceHint: "这会决定我们为您安排多少家酒庄。",
    days: "想安排几天行程？",
    daysHint: "我们会为每一天规划全新的路线。",
    transport: "需要我们安排接送吗？",
    pickup: "接送地址",
    pickupPlaceholder: "开始输入您的地址",
    startingAddress: "您从哪里出发？",
    startingAddressHint: "选填——告诉我们出发地，路线会安排得更顺。",
    wineStyles: "您偏爱哪一类葡萄酒？",
    wineStylesHint: "可多选——选「给我惊喜」也很好。",
    experiences: "有特别想体验的吗？",
    experiencesHint: "选填——我们会把合适的安排进您的行程。",
    occasion: "这趟来访的缘由是？",
    budget: "每人大致预算是多少？",
    budgetHint: "指品鉴与体验的花费——接送费用另算。",
    dietary: "有特别的饮食需求吗？",
    dietaryHint: "好让每一餐与搭配都照顾到同行的每一位。",
    accessibility: "有无障碍方面的需求吗？",
    accessibilityHint: "我们只会推荐能让您宾至如归的酒庄。",
    accessibilityPlaceholder: "还有什么需要我们留意的吗？（选填）",
  },
  transport: {
    yes: "需要，请安排接送",
    no: "不用，我们自驾",
    hintYes: "我们会为您安排一整天的豪华专车。",
    hintNo: "您自行前往就好——没问题。",
  },
  ui: {
    ...en.ui,
    ...
    step: "第",
    of: "步，共",
    asideNote: "「您分享得越多，这一天就越像为您而生——而非照单安排。」",
    noPreference: "无偏好",
    language: "语言",
    daysUnit: "天",
    loading: "正在为您编排这一天…",
  ...
  errors: {
    date: "请先选择您的出行日期。",
    datePast: "这个日期已过——请另选一个即将到来的日子。",
    group: "同行至少需要一位。",
    pickup: "请填写接送地址，方便我们安排车辆。",
    wine: "请至少选择一种酒款风格——选「给我惊喜」也完全可以。",
    noPlan: "未来 14 天内，未能为这些偏好找到合适的预览行程。",
  },
  rationale: {
    kicker: "礼宾寄语",
    greeting: "{name}，您好：",
    ...
    bodyTransport:
      "我们为{group}精心编排了{pace}：{n} 家酒庄串成一条顺畅的路线，每段都有专属司机接送，您只需尽情享受杯中之物与一路谈笑。",
    bodySelf:
      "我们为{group}精心编排了{pace}：{n} 家酒庄串成一条轻松好走、指示清晰的路线，您可按自己的节奏从容前行。",
    chipsLabel: "为您精选",
    signoff: "Tailor Moments 礼宾团队 敬上",
  },
  result: {
    ...en.result,
    kicker: "为您量身打造",
    ...
    pp: "每位",
    depart: "离开",
    driveYes: "专车车程 {n} 分钟，前往下一站",
    driveNo: "悠然车程 {n} 分钟，前往下一站",
    driveFromYes: "专车车程 {n} 分钟，从接送点前往第一家酒庄",
    driveFromNo: "车程 {n} 分钟，从出发点前往第一家酒庄",
    subtotal: "品鉴费小计",
    forGuests: "共 {n} 位宾客",
    forGuest: "共 {n} 位宾客",
    note: "为这一天画上优雅的句点。接送与特别体验将在预订时确认。",
    stopNote: "为您的到访安排的一场专人主理品鉴。",
    whyLabel: "我们为您如此安排的理由",
    lunchLabel: "午餐",
    lunchNote: "在行程中为您留出一段从容的午餐时光。",
    weatherWear: "着装建议",
    weatherForecast: "天气预报",
    weatherTypical: "这个时节的常见天气",
    rainChance: "降雨概率 {n}%",
    dayHeading: "第 {n} 天",
    loaderCaptions: [
      "正在为您编排山谷间的一天…",
  ...
  summary: {
    pageTitle: "行程概览",
    pageIntro: "预订前，请先确认您的行程与费用。",
    noSummaryTitle: "还没有行程概览",
    ...
    contactEmailPh: "you@example.com",
    subtotalLabel: "品鉴费小计",
    pricedNote: "{priced} 站已标明价格，{missing} 站尚未公开品鉴价。",
    transportNote: "接送费用与特别体验将在预订时确认。",
    customise: "调整行程",
    bookTour: "确认预订",
    booking: "正在预订…",
    bookingCreated: "预订成功，编号 {ref}。",
    mapTitle: "您的酒庄地图",
    mapNote: "房屋图标是您的出发点，编号图标按到访顺序排列。",
    mapMissing: "{n} 站暂缺坐标，尚未显示在地图上。",
    needContact: "预订前请填写您的称呼与邮箱。",
    bookingFailed: "暂时无法创建预订。",
  },
  pace: {
    relaxed: { label: "悠闲", note: "从容的节奏 · 两家酒庄，留足余裕" },
    balanced: { label: "尽兴体验", note: "舒适的一整日 · 约三家酒庄" },
    maximise: { label: "尽情畅游", note: "在时间允许内尽量多走几家 · 至多四家酒庄" },
  },
  wineStyles: {
    organic_biodynamic: { label: "有机与生物动力", desc: "以自然之道酿造" },
    well_known_names: { label: "知名酒庄", desc: "玛格丽特河的标志性名庄" },
    hidden_gems: { label: "隐世佳酿", desc: "市面难寻的精品小庄" },
    family_estates: { label: "家族酒庄", desc: "亲切而富有故事的酒窖" },
    award_winning: { label: "屡获殊荣", desc: "享誉国际的卓越品质" },
    surprise_me: { label: "给我惊喜", desc: "由我们甄选当下最出色的" },
  },
  experiences: {
    winery_lunch: { label: "酒庄午餐", desc: "葡萄藤间的悠长午宴" },
    cheese_wine: { label: "芝士配酒", desc: "本地芝士拼盘，悉心搭配" },
    wine_chocolate: { label: "葡萄酒与巧克力", desc: "更甜美的搭配品鉴" },
    cellar_tour: { label: "酒窖探访", desc: "随酿酒师走进幕后" },
    blending_experience: { label: "调配体验", desc: "亲手调出一瓶带回家" },
    private_tasting_room: { label: "私人品鉴室", desc: "只属于您们的专属接待" },
    sunset_tasting: { label: "日落品鉴", desc: "葡萄园上的黄金时分" },
    vineyard_walk: { label: "葡萄园漫步", desc: "在两杯之间舒展身心" },
  },
  occasions: {
